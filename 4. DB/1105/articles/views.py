...
from django.contrib.auth.decorators import login_required # 로그인한 사용자만 
...
@login_required # 로그인한 사용자만 댓글 달기 위해서
@require_POST
...
@login_required # 선택사항 
@require_http_methods(['GET', 'POST']) # 방식이 2개 
def create(request):
...
# create 와 update는 서로 다른 페이지를 사용해야 함. 
# 새로운 거 만들기 / 기존에 있던 거 수정하기 
